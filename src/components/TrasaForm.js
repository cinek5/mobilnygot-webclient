  ...
  render() {
    return (
      <div>
        ...
        <AddPunktModal addPunkt={this.addNewPunkt.bind(this)} onClose={this.closeModal.bind(this)}
                       isModalOpen={this.state.isAddPunktModalOpen} grupa={this.state.trasa.grupaGorska}/>
        <div className="row">
          ...
          <form className="col s11">
            <div className="row">
              <div className="input field col s7 ">
                ...
                <ListaPunktow changeOrder={this.changePunktOrder.bind(this)}
              ...
              <div className="col s4">
                ...
                enabled={this.state.trasa.skladowePunktyTrasy.length==0}/>

                <label className="white-text">Data wprowadzenia trasy</label>
                <input required name="dataDodania" className="white-text" onChange={this.handleInput.bind(this)}
                       type="date"/>

                <div className="input field">
                  <label className="white-text">Liczba punktów do zdobycia</label>
                  <input required min="0" name="punktyRegulaminowe" onChange={this.handleInput.bind(this)}
